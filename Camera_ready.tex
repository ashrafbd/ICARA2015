...
A robot operating in WSN assisted environments can dynamically push instructions using over the air (OTA) update protocols to alter sensors to suit their requirements.
...
updates primarily indicates uploading inappropriate software
that performs undesired actions, having replacing the
...
The experimental results are based on simulations in NS-2.\footnote{NS-2 is a open-source real-time network simulation tool that can be used to define different scenario}
