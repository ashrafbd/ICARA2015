...
%[path tagging is good, but in all cases, whatb s the risk from intruders messing with the reported data?]
...
\bibitem{Shue13}
S.~Shue and J.~Conrad, ``A survey of robotic applications in wireless sensor
  networks,'' in \emph{Southeastcon, 2013 Proceedings of IEEE}, April 2013, pp.
  1--5.

\bibitem{ISI:000253439700120}
A.~Bari, A.~Jaekel, and S.~Bandyopadhyay, ``{Optimal placement of relay nodes
  in two-tiered, fault tolerant sensor networks},'' in \emph{{2007 IEEE
  SYMPOSIUM ON COMPUTERS AND COMMUNICATIONS, VOLS 1-3}}, ser. {IEEE Symposium
  on Computers and Communications ISCC}.\hskip 1em plus 0.5em minus 0.4em\relax
  {IEEE; IEEE Commun Soc; IEEE Comp Soc; Inst Telecommun; Univ Aveiro;
  Inovacao; AT\&T}, {2007}, pp. {809--814}, {12th IEEE Symposium on Computers
  and Communications, Aveiro, PORTUGAL, JUL 01-04, 2007}.

\bibitem{1031506}
J.~W. Hui and D.~Culler, ``The dynamic behavior of a data dissemination
  protocol for network programming at scale,'' in \emph{SenSys '04: Proceedings
  of the 2nd international conference on Embedded networked sensor
  systems}.\hskip 1em plus 0.5em minus 0.4em\relax New York, NY, USA: ACM,
  2004, pp. 81--94.

\bibitem{quing09}
Q.~Wang and T.~Zhang, \emph{Security in RFID and Sensor Networks}.\hskip 1em
  plus 0.5em minus 0.4em\relax Auerbach Publications, April 2009, ch. A Survey
  on Security of Wireless Network, pp. 293--320.

\bibitem{tep116}
P.~Levis, ``{TEP} 116: Packet protocols,'' TinyOS Core Working Group, Tech.
  Rep., 2012, tinyOS-Version: > 2.1.

\bibitem{aes2011}
A.~Bogdanov, D.~Khovratovich, and C.~Rechberger,
  ``\BIBforeignlanguage{English}{Biclique cryptanalysis of the full aes},'' in
  \emph{\BIBforeignlanguage{English}{Advances in Cryptology ASIACRYPT
  2011}}, ser. Lecture Notes in Computer Science, D.~Lee and X.~Wang,
  Eds.\hskip 1em plus 0.5em minus 0.4em\relax Springer Berlin Heidelberg, 2011,
  vol. 7073, pp. 344--371.

\bibitem{DBLP:journals/corr/abs-1301-3022}
M.~Y. Malik, ``{An Outline of Security in Wireless Sensor Networks: Threats,
  Countermeasures and Implementations},'' \emph{CoRR}, vol. abs/1301.3022,
  2013.

\bibitem{Karlof:2004:TLL:1031495.1031515}
C.~Karlof, N.~Sastry, and D.~Wagner, ``Tinysec: A link layer security
  ...
  International Conference on Embedded Networked Sensor Systems}, 2004, pp.
  162--175.

\bibitem{372146}
K.~Ilgun, R.~Kemmerer, and P.~Porras, ``{State Transition Analysis: a
  Rule-based Intrusion Detection Approach},'' \emph{Software Engineering, IEEE
  Transactions on}, vol.~21, no.~3, pp. 181--199, Mar 1995.

\bibitem{1515559}
I.~Onat and A.~Miri, ``A real-time node-based traffic anomaly detection
  algorithm for wireless sensor networks,'' in \emph{Systems Communications,
  2005. Proceedings}, Aug 2005, pp. 422--427.

\bibitem{ISI:000298891500099}
F.~Santoso, ``{A Decentralised Self-dispatch Algorithm for Square-grid Blanket
  Coverage Intrusion Detection Systems in Wireless Sensor Networks},'' in
  \emph{{2011 IEEE VEHICULAR TECHNOLOGY CONFERENCE (VTC FALL)}}, ser. {IEEE VTS
  Vehicular Technology Conference Proceedings}.\hskip 1em plus 0.5em minus
  0.4em\relax {IEEE; IEEE Vehicular Technol Soc}, {2011}, {IEEE 74th Vehicular
  Technology Conference (VTC), San Francisco, CA, SEP 05-08, 2011}.

\bibitem{Chen:2009:NMI:1516241.1516282}
R.-C. Chen, C.-F. Hsieh, and Y.-F. Huang, ``A new method for intrusion
  detection on hierarchical wireless sensor networks,'' in \emph{Proceedings of
  the 3rd International Conference on Ubiquitous Information Management and
  Communication}, ser. ICUIMC '09.\hskip 1em plus 0.5em minus 0.4em\relax New
  York, NY, USA: ACM, 2009, pp. 238--245.

\bibitem{1424814}
C.-C. Su, K.-M. Chang, Y.-H. Kuo, and M.-F. Horng, ``The new intrusion
  prevention and detection approaches for clustering-based sensor networks
  [wireless sensor networks],'' in \emph{Wireless Communications and Networking
  Conference, 2005 IEEE}, vol.~4, March 2005, pp. 1927--1932 Vol. 4.

\bibitem{Strikos_afull}
A.~A. Strikos, ``A full approach for intrusion detection in wireless sensor
  networks,'' 2007.

\bibitem{ISI:000257882502160}
S.~Rajasegarar, C.~Leckie, M.~Palaniswami, and J.~C. Bezdek, ``{Quarter sphere
  based distributed anomaly detection in wireless sensor networks},'' in
  \emph{{2007 IEEE INTERNATIONAL CONFERENCE ON COMMUNICATIONS, VOLS 1-14}},
  ser. {IEEE International Conference on Communications}, {2007}, pp.
  {3864--3869}.

\bibitem{1593102}
R.~Roman, J.~Zhou, and J.~Lopez, ``Applying intrusion detection systems to
  wireless sensor networks,'' in \emph{Consumer Communications and Networking
  Conference, 2006. CCNC 2006. 3rd IEEE}, vol.~1, Jan 2006, pp. 640--644.

\bibitem{1290173}
S.~Doumit and D.~Agrawal, ``Self-organized criticality and stochastic learning
  based intrusion detection system for wireless sensor networks,'' in
  \emph{Military Communications Conference, 2003. MILCOM '03. 2003 IEEE},
  vol.~1, Oct 2003, pp. 609--614 Vol.1.

\bibitem{4024996}
E.-H. Ngai, J.~Liu, and M.~Lyu, ``On the intruder detection for sinkhole attack
  in wireless sensor networks,'' in \emph{Communications, 2006. ICC '06. IEEE
  International Conference on}, vol.~8, June 2006, pp. 3383--3389.

\bibitem{4085803}
S.~Rajasegarar, C.~Leckie, M.~Palaniswami, and J.~Bezdek, ``Distributed anomaly
  detection in wireless sensor networks,'' in \emph{Communication systems,
  2006. ICCS 2006. 10th IEEE Singapore International Conference on}, Oct 2006,
  pp. 1--5.

\bibitem{Ko2001}
C.~Ko, P.~Brutch, J.~Rowe, G.~Tsafnat, and K.~N. Levitt, ``{System Health and
  Intrusion Monitoring Using a Hierarchy of Constraints},'' in
  \emph{{Proceedings of the 4th International Symposium on Recent Advances in
  Intrusion Detection}}, ser. RAID '00.\hskip 1em plus 0.5em minus 0.4em\relax
  London, UK: Springer-Verlag, 2001, pp. 190--204.

\bibitem{1639675}
B.~Yu and B.~Xiao, ``Detecting selective forwarding attacks in wireless sensor
  networks,'' in \emph{Parallel and Distributed Processing Symposium, 2006.
  IPDPS 2006. 20th International}, April 2006.

\bibitem{6096939}
D.~yin Zhang, C.~Xu, and L.~Siyuan, ``Detecting selective forwarding attacks in
  wsns using watermark,'' in \emph{Wireless Communications and Signal
  Processing (WCSP), 2011 International Conference on}, Nov 2011, pp. 1--4.

\bibitem{sink08}
I.~Krontiris, T.~Dimitriou, T.~Giannetsos, and M.~Mpasoukos, ``Intrusion
  detection of sinkhole attacks in wireless sensor networks,'' in
  \emph{Algorithmic Aspects of Wireless Sensor Networks}, ser. Lecture Notes in
  Computer Science, M.~Kutylowski, J.~Cichon, and P.~Kubiak, Eds.\hskip 1em
  plus 0.5em minus 0.4em\relax Springer Berlin Heidelberg, 2008, vol. 4837, pp.
  150--161.

\bibitem{5172466}
T.~Giannetsos, T.~Dimitriou, and N.~Prasad, ``State of the art on defenses
  against wormhole attacks in wireless sensor networks,'' in \emph{Wireless
  Communication, Vehicular Technology, Information Theory and Aerospace
  Electronic Systems Technology, 2009. Wireless VITAE 2009. 1st International
  Conference on}, May 2009, pp. 313--318.

\bibitem{aalam14}
A.~S. M.~A. Alam, D.~Eyers, and Z.~Huang, ``Intrusion detection within a
  wireless sensor network over the air update protocol,'' in \emph{IEEE
  International Conference on Advanced Information Networking and Applications
  (AINA-2015)}.\hskip 1em plus 0.5em minus 0.4em\relax IEEE, May 2015, under
  review.

\bibitem{1512911}
I.~Onat and A.~Miri, ``An intrusion detection system for wireless sensor
  networks,'' in \emph{Wireless And Mobile Computing, Networking And
  Communications, 2005. (WiMob'2005), IEEE International Conference on},
  vol.~3, Aug 2005, pp. 253--259 Vol. 3.

\bibitem{Pister08tsmp:time}
K.~S.~J. Pister and L.~Doherty, ``{TSMP}: Time synchronized mesh protocol,'' in
  \emph{In Proceedings of the IASTED International Symposium on Distributed
  Sensor Networks (DSN08)}, 2008.
