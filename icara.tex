...
They not suitable for heavy computational tasks because of constraints like power, memory, storage, and severe energy. 
On the other hand, robots have greater capabilities like mobility, performing resource intensive tasks, operating in unfavourable
environments.
...
The first contribution of the research is quantifying intrusion through an IWS. 
...
It can also decide on the extend of intrusion basing on reported software version information.
